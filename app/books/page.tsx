  ...
  const books: Book[] = [
    {
      id: 1,
      title: 'Kalkulus 1',
      author: 'Abdul Wahhab, Patrick Darian, Fritz Adelbertus Sitindaon, Natalius Desta Riyanto',
      ...
      price: 'Rp 79.000',
      image: 'https://i.imgur.com/uknEIwe.png',
      category: 'Kalkulus',
    ...
    },
    {
      ...
      author: 'Abdul Wahhab, Renzie Aditya, Almaas Suthonu Alandra',
      ...
      price: 'Rp 45.000',
      image: 'https://i.imgur.com/JYm0tID.png',
      category: 'PDB',
      buyLink: 'https://feynmanbookstore.vercel.app/',
    ...
    },
    {
      id: 5,
      title: 'Kalkulus 3',
      author: 'Abdul Wahhab, Bryan Jonathan, Muhammad Luhur AlFajri',
      ...
      price: 'Rp 60.000',
      image: 'https://i.imgur.com/NyVPH1l.png',
      category: 'Kalkulus',
      buyLink: 'https://feynmanbookstore.vercel.app/',
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            {[
              ...
              { src: 'https://i.imgur.com/rKOO938.png', name: 'Albert Wijaya' },
