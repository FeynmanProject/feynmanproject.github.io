  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-white">
      ...
      <section className="relative py-20 bg-gradient-to-br from-[#0D0D0D] via-[#1A0D1A] to-[#0D0D0D]">
        <div className="absolute inset-0 bg-[url('https://https://static.readdy.ai/image/420ea21a139446d9f8dbe141258338d9/c16f33e516c935c238bc0bb121b39ee2.jfif')] bg-cover bg-center opacity-15"></div>
